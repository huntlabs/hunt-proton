...
module hunt.proton.codec.MapType;
...
interface MapEncoding : PrimitiveTypeEncoding!(Map!(String,Object))
{
   void setValue(Map!(String,Object) value, int length);
}

class MapType : AbstractPrimitiveType!(Map!(String,Object))
{
    ...
    this(EncoderImpl encoder, DecoderImpl decoder)
    {
        ...
        encoder.register(typeid(LinkedHashMap!(String,Object)), this);
        decoder.register(this);
    }

    public TypeInfo getTypeClass()
    {
        return typeid(LinkedHashMap!(String,Object));
    }
    ...
    {
        int calculatedSize = calculateSize(cast(Map!(String,Object))val);
        MapEncoding encoding = ((cast(Map!(String,Object))val).size() > 127 || calculatedSize >= 254)
                                    ? _mapEncoding
                                    : _shortMapEncoding;

        encoding.setValue(cast(Map!(String,Object))val, calculatedSize);
        return encoding;
    }

    private int calculateSize(Map!(String,Object) map)
    {
        ...
        try
        {
            ...
            foreach (MapEntry!(String, Object) element ; map)
            {
    ...
    //Collection!(TypeEncoding!(Map!(String,Object)))
    public Collection!(TypeEncoding!(Map!(String,Object))) getAllEncodings()
    {
        ArrayList!(TypeEncoding!(Map!(String,Object))) lst = new ArrayList!(TypeEncoding!(Map!(String,Object)))();
    ...
    class AllMapEncoding
            : LargeFloatingSizePrimitiveTypeEncoding!(Map!(String,Object))
            , MapEncoding
    {
        ...
        override
        protected void writeEncodedValue(Map!(String,Object) map)
        {
          ...
          //  Iterator<Map.Entry> iter = map.entrySet().iterator();
            ...
            try
            {
                foreach (MapEntry!(String, Object) element ; map)
                {
                    ...
                    if (IfixedKeyType is null)
                    {
                        StringType tmp = cast(StringType)(_encoder.getType( element.getKey()));
                        if (tmp is null)
                        {
                            logError( "getType Error");
                        }
        ...
        override
        protected int getEncodedValueSize(Map!(String,Object) val)
        {
        ...
        override
        public bool encodesSuperset(TypeEncoding!(Map!(String,Object)) encoding)
        {
        ...
        public Object readValue()
        {
            ...
            for(int i = 0; i < count / 2; i++)
            {
                ...
                String key = cast(String)keyConstructor.readValue();
        ...
        public void setValue(Map!(String,Object) value, int length)
        {
            _value = value;
            _length = length;
        }
    ...
    class ShortMapEncoding
            : SmallFloatingSizePrimitiveTypeEncoding!(Map!(String,Object))
            , MapEncoding
    {
        private Map!(String,Object) _value;
        private int _length;
        ...
        override
        public bool encodesSuperset(TypeEncoding!(Map!(String,Object)) encoder)
        {
            return encoder == this;
        }
